    ...
    <TooltipProvider delayDuration={200}>
      <div className="min-h-screen bg-[#09090B] text-white">
        <div className="max-w-6xl mx-auto px-4 py-8 sm:px-6 lg:px-8">
          ...
          >
            <div>
              <h1 className="text-2xl sm:text-3xl font-bold tracking-tight bg-linear-to-r from-orange-400 to-orange-600 bg-clip-text text-transparent">
                AI Bridge
              </h1>
            ...
            {services.map((service) => {
              ...
              return (
                <motion.div
                  ...
                  transition={{ duration: 0.3 }}
                >
                  <Card className="p-4 border border-white/6 bg-[#0C0C0E]">
                ...
                <Card className="p-4 border border-white/6 bg-[#0C0C0E]">
                  ...
                  <div className="flex items-center gap-2">
                    <Input
                      ...
                      className="bg-white/4 border-white/8 text-white placeholder:text-white/25 focus-visible:border-orange-500/40"
                      onKeyDown={(e) => e.key === "Enter" && handleGenerate()}
                    />
                    <Button
                      onClick={handleGenerate}
                      disabled={!prompt.trim() || isGenerating}
                      className="bg-linear-to-r from-orange-600 to-orange-500 text-white shadow-lg shadow-orange-500/25"
                    >
                      {isGenerating ? (
